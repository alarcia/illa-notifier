...
class CatalogSyncService:
    ...
    def sync(self, billboard: BillboardData) -> SyncResult:
        ...
        for movie in billboard.movies:
            ...
            if self.db.is_new_movie(movie_id):
                ...
                subscribers = self.db.get_matching_subscribers(movie_id, formats, genre)
                ...
                existing_formats = self.db.get_movie_formats(movie_id)
                ...
                if new_formats:
                    ...
                    subscribers = self.db.get_matching_subscribers(movie_id, new_formats, genre)
                    for tg_id in subscribers:
        ...
        if new_movies_for_email:
            ...
            for movie_data, formats in new_movies_for_email:
                email_subs = self.db.get_email_subscribers(movie_data.movie_id, formats, movie_data.genre)
